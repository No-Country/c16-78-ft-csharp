...
const IngredientFilter = () => {
    ...
    return (
        <div className="relative py-6 lg:w-1/3 px-8 lg:bg-gray-100 lg:h-screen lg:sticky lg:top-0">
            <div className="flex lg:flex-col items-center gap-x-5 gap-y-5 mb-5">
                ...
                <div className="flex w-full bg-gray-100 lg:bg-white px-2 rounded-lg">
                    ...
                    <input className="flex-grow bg-gray-100 lg:bg-white px-2 focus:outline-none" type="text" placeholder="Frutas, verduras, lacteos, proteinas..." onKeyPress={handleEnterPress} />
                </div>
            </div>
